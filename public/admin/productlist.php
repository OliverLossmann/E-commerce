...
<div class="collapse navbar-collapse" id="main-navigation">
		<ul class="navbar-nav">
            ...
            <li class="nav-item">
			<a class="nav-link" type="button" name="products" href='creatprod.php'>Create New Product</a>
			</li>
			<li class="nav-item">
...
<div class="container features">
  <div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
      <a  href="viewprod.php?id=<?php echo $post['id'];?>"><img class="img-fluid" src="<?php echo $post['img_url']?>"></a>
      <p><a href="../public/viewprod.php?id=<?php echo $post['id'];?>"><?php echo $post['title'];?></a> <a class="price"><?php echo $post['price'];?> KR </a></p>
